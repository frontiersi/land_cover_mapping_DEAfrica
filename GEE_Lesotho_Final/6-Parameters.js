exports.LCParams = function(){
  ...
  var lc_params_dict = {
    ...
    'COLLECTION': 'COPERNICUS/S2_HARMONIZED', // Whether to use L1C ("COPERNICUS/S2") or L2A ("COPERNICUS/S2_SR") data. L2A data is available from 2019 onwards.
    'BAND_LIST': ['B2', 'B3', 'B4', 'B5', 'B6', 'B7', 'B8', 'B11', 'B12', 'NDVI'], // S2 Bands to use as DTW input
